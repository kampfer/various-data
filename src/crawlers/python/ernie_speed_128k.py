...
def ie_by_ernie(content):
    ...
    question3 = f"你是一个自然语言处理专业机器人，你需要从我给出的内容中抽取[逆回购操作的期限、中标量和中标利率]，并使用[json]格式输出结果"
    ...
    payload = json.dumps({"messages": [{"role": "user", "content": question3}]})
