...
export interface TransactionOut { id: number; accountId: number | null; accountName: string | null; accountInstitution: string | null; productType: ProductType; productName: string; productCode: string; transactionPrice: string; transactionQuantity: string; fee: string; direction: TradeDirection; tradeDate: string; /** 基金确认日期；非基金或旧数据可能为空。 */ confirmationDate?: string | null; }
export interface HoldingAccount { accountId: number | null; accountName: string | null; accountInstitution: string | null; }
export interface HoldingOut { productType: ProductType; productName: string; productCode: string; accounts: HoldingAccount[]; position: Metric; positionQuantity: Metric; latestValuationUnitPrice: Metric; latestValuationDate: string | null; totalProfit: Metric; totalProfitRate: Metric; annualizedRate: Metric; }
