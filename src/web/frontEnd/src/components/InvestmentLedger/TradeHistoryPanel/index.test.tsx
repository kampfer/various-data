...
const items: TransactionOut[] = [
  ...
  { id: 1, productType: 'FUND', productName: '基金', productCode: 'F001', transactionPrice: '1.2345', transactionQuantity: '2.5', fee: '0', direction: 'BUY', tradeDate: '2024-01-01' },
  // 股票：单价保持原样 10.123（不格式化）
  { id: 2, productType: 'STOCK', productName: '股票', productCode: 'S001', transactionPrice: '10.123', transactionQuantity: '100', fee: '5.00', direction: 'SELL', tradeDate: '2024-01-02' },
  // 理财：净值 0.99999 → 展示为 1.0000（四舍五入到 4 位）
  { id: 3, productType: 'WEALTH', productName: '理财', productCode: 'W001', transactionPrice: '0.99999', transactionQuantity: '10000', fee: '0', direction: 'BUY', tradeDate: '2024-01-03' },
];
